Descrição
Este é um aplicativo Android simples que exibe mensagens motivacionais pré cadastradas.
...
bash
Copy code
git clone https://github.com/Sergio-U-Trindade/App-Frases_Motivacionais.git
